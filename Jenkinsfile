...
selectedInputs = input(
  id: 'Proceed', message:'Choose something', parameters: [
  [$class: 'WHideParameterDefinition', defaultValue: "some java option", description: 'Make decision', name:'javaOpts'],
  [$class: 'WHideParameterDefinition', defaultValue: "1", description: 'Make decision', name:'replicaCount']
